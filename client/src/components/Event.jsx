...
export default function Event({
  ...
  // Lock background scrolling when event modal is open, re-enable on close/cancel
  useEffect(() => {
    if (selectedEvent) {
  ...
  return (
    <>
      ...
      {/* ── MODAL via Portal — renders directly into document.body to escape transform stacking context ── */}
          ...
          >
            <div
              ...
              style={{
                ...
                boxSizing: 'border-box',
                background: isDarkMode
                  ? 'linear-gradient(135deg, rgba(15, 35, 66, 0.98) 0%, rgba(27, 53, 84, 0.96) 100%)'
                  : '#ffffff',
                color: isDarkMode ? '#ffffff' : '#0f2342',
                border: isDarkMode ? '1px solid rgba(56, 189, 248, 0.25)' : '1px solid rgba(226, 232, 240, 0.9)',
                boxShadow: isDarkMode ? '0 25px 50px rgba(0,0,0,0.7)' : '0 25px 50px rgba(0,0,0,0.2)',
            ...
            >
              ...
              <span style={{
                ...
                background: isDarkMode ? 'rgba(56, 189, 248, 0.15)' : 'rgba(2, 132, 199, 0.1)',
                color: isDarkMode ? '#38bdf8' : '#0284c7', fontWeight: '600'
              }}>
              ...
              {showGuestPrompt ? (
                <div style={{ textAlign: 'center' }}>
                  <img src={couponIcon} alt="Event ticket" style={{ width: '52px', height: '52px', objectFit: 'contain', marginBottom: '10px' }} />
                  ...
                  <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <button
                      ...
                      style={{
                        ...
                        color: isDarkMode ? '#38bdf8' : '#0284c7', fontSize: '0.9rem', fontWeight: '700', cursor: 'pointer',
                        display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', transition: 'all 0.2s ease'
                      }}
                    >
                      <img src={isDarkMode ? gradCapDark : gradCapLight} alt="Student" style={{ width: '36px', height: '36px', objectFit: 'contain' }} />
                      Student
                    ...
                    <button
                      ...
                      style={{
                        ...
                        color: isDarkMode ? '#a78bfa' : '#7c3aed', fontSize: '0.9rem', fontWeight: '700', cursor: 'pointer',
                        display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', transition: 'all 0.2s ease'
                      }}
                    >
                      <img src={isDarkMode ? userIconDark : userIconLight} alt="Guest" style={{ width: '36px', height: '36px', objectFit: 'contain' }} />
                      Non-Student / Guest
                  ...
                  <div style={{ marginTop: '14px' }}>
                    <button
                      ...
                      style={{
                        background: 'none', border: 'none',
                        color: isDarkMode ? '#80aad3' : '#64748b',
                        fontSize: '0.85rem', cursor: 'pointer', textDecoration: 'underline', padding: '4px 8px'
                      }}
                    >
                      Cancel
                    </button>
                ...
                <form onSubmit={handleRegisterSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                  ...
                  <input
                    ...
                    style={{ padding: '10px 14px', borderRadius: '8px', border: isDarkMode ? '1px solid rgba(56, 189, 248, 0.2)' : '1px solid rgba(203, 213, 225, 0.9)', background: isDarkMode ? 'rgba(10, 24, 46, 0.7)' : '#f8fafc', color: isDarkMode ? '#ffffff' : '#0f2342', fontSize: '0.85rem', outline: 'none' }}
                  />
                  <input
                  ...
                  {userType === 'student' && (
                    <input
                      type="text" placeholder="Student ID Number" required
                  ...
                  <div style={{ display: 'flex', gap: '10px', marginTop: '8px' }}>
                    <button
                      ...
                      style={{
                        flex: 1, padding: '10px', fontSize: '0.85rem', borderRadius: '8px',
                        border: isDarkMode ? '1px solid rgba(56, 189, 248, 0.2)' : '1px solid rgba(203, 213, 225, 0.9)',
                        background: 'transparent', color: isDarkMode ? '#80aad3' : '#475569',
                    ...
                    <button type="submit"
                      className="submit-btn"
                      disabled={isSubmitting}
                      style={{ flex: 2, padding: '10px', fontSize: '0.85rem', fontWeight: '700', cursor: isSubmitting ? 'not-allowed' : 'pointer', opacity: isSubmitting ? 0.7 : 1 }}
                    >
