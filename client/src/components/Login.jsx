...
export default function Login({ 
  ...
  const [showPassword, setShowPassword] = useState(false); // State para sa toggle
      ...
      <div className="auth-container" style={{ justifyContent: 'center', alignItems: 'center', padding: '40px 20px' }}>
        <div className="auth-card-pro" style={{ maxWidth: '420px', width: '100%', padding: '40px' }}>
          {isPageLoading ? (
            ...
            <>
              <h2 style={{ fontSize: '1.8rem', color: '#ffffff', marginBottom: '8px', fontWeight: '700' }}>Welcome Back</h2>
              <p style={{ fontSize: '0.9rem', color: '#94a3b8', marginBottom: '25px' }}>Enter your credentials to access your account.</p>
              ...
              <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                ...
                <div>
                  ...
                  <input 
                    type={showPassword ? "text" : "password"} // Dynamic type batay sa checkbox
                    placeholder="••••••••"
                    value={password}
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '8px' }}>
                    ...
                    />
                    <label htmlFor="showPassLogin" style={{ fontSize: '0.8rem', color: '#94a3b8', cursor: 'pointer', userSelect: 'none' }}>
                      Show password
                    </label>
                  </div>
                </div>
              ...
              <p style={{ textAlign: 'center', fontSize: '0.85rem', color: '#94a3b8', marginTop: '25px' }}>
